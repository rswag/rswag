...
if Rails.version.first.to_i < 5
  ...
  TestApp::Application.config.secret_token = <<~HEX
    60f36cd33756d73f362053f1d45256ae50d75440b634ae73b070a6e35a2df38692f59e28e5ecbd1f9f2e850255f6d29a468bc59ac4484c2b7f0548ddbfc1b870
  HEX
else
  # See http://guides.rubyonrails.org/upgrading_ruby_on_rails.html#config-secrets-yml
  TestApp::Application.config.secret_key_base = <<~HEX
