...
However, auto generated example responses are possible in rswag. See below.
```ruby
# spec/integration/blogs_spec.rb
describe 'Blogs API' do
  ...
  path '/blogs/{blog_id}' do
    ...
    get 'Retrieves a blog' do
      produces "application/json" # IMPORTANT FOR EXAMPLES TO WORK
...
You can also avoid the dry run when executing from the command line with
